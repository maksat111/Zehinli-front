        ...
        <div id='download' className='flex items-center w-90vw lg:h-80vh'>
            <motion.div initial={{ y: 200 }} whileInView={{ y: 0 }} transition={{ duration: 0.5 }} className='bg-gradient-to-r pt-20 pb-0 px-7 from-[#4F9AEB] to-[#007BFF] rounded-[20px] flex flex-row-reverse justify-center w-[90vw] lg:pt-5 lg:grid lg:grid-cols-2 lg:h-[50vh]'>
                ...
                <div className='z-2 absolute right-[0vh] flex lg:gap-[-100px] justify-center h-50vh w-80vw lg:w-[47vw]'>
                    <motion.img initial={{ rotate: 45, scale: 1.6, y: 200, x: -200 }} whileInView={{ rotate: 0, y: 0, x: 0, scale: 1 }} transition={{ duration: 0.8 }} className='relative min-w-[15rem] h-[23rem] bottom-[16rem] sm:min-w-[18rem] sm:h-[27rem] md:min-w-[20rem] md:h-[30rem] md:bottom-[18rem] lg:bottom-[9rem] lg:h-[35rem] lg:min-w-[21rem]' src={phone} alt='Phone' />
                    <motion.img initial={{ rotate: -45, scale: 1.6, y: 200, x: 200 }} whileInView={{ rotate: 0, y: 0, x: 0, scale: 1 }} transition={{ duration: 0.8 }} className='relative z-2 min-w-[15rem] right-[5rem] bottom-[12.5rem] h-[23rem] sm:min-w-[18rem] sm:h-[27rem] md:min-w-[20rem] md:h-[30rem] md:bottom-[14.5rem] lg:h-[35rem] lg:bottom-[3rem] lg:min-w-[21rem]' src={leaderboard} alt='Phone' />
                </div>
            </motion.div>
        </div>
    );
